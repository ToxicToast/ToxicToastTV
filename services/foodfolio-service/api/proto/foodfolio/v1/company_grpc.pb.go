...
const (
	CompanyService_CreateCompany_FullMethodName = "/foodfolio.v1.CompanyService/CreateCompany"
	CompanyService_GetCompany_FullMethodName    = "/foodfolio.v1.CompanyService/GetCompany"
	CompanyService_ListCompanies_FullMethodName = "/foodfolio.v1.CompanyService/ListCompanies"
	CompanyService_UpdateCompany_FullMethodName = "/foodfolio.v1.CompanyService/UpdateCompany"
	CompanyService_DeleteCompany_FullMethodName = "/foodfolio.v1.CompanyService/DeleteCompany"
)
...
type CompanyServiceClient interface {
	...
	DeleteCompany(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
}
...
func (c *companyServiceClient) DeleteCompany(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CompanyServiceServer interface {
	...
	DeleteCompany(context.Context, *IdRequest) (*SuccessResponse, error)
...
func (UnimplementedCompanyServiceServer) DeleteCompany(context.Context, *IdRequest) (*SuccessResponse, error) {
...
var CompanyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foodfolio.v1.CompanyService",
