...
const (
	LocationService_CreateLocation_FullMethodName  = "/foodfolio.v1.LocationService/CreateLocation"
	LocationService_GetLocation_FullMethodName     = "/foodfolio.v1.LocationService/GetLocation"
	LocationService_ListLocations_FullMethodName   = "/foodfolio.v1.LocationService/ListLocations"
	LocationService_UpdateLocation_FullMethodName  = "/foodfolio.v1.LocationService/UpdateLocation"
	LocationService_DeleteLocation_FullMethodName  = "/foodfolio.v1.LocationService/DeleteLocation"
	LocationService_GetLocationTree_FullMethodName = "/foodfolio.v1.LocationService/GetLocationTree"
)
...
type LocationServiceClient interface {
	...
	DeleteLocation(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
...
func (c *locationServiceClient) DeleteLocation(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type LocationServiceServer interface {
	...
	DeleteLocation(context.Context, *IdRequest) (*SuccessResponse, error)
...
func (UnimplementedLocationServiceServer) DeleteLocation(context.Context, *IdRequest) (*SuccessResponse, error) {
...
var LocationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foodfolio.v1.LocationService",
