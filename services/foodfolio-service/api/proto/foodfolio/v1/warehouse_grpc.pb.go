...
const (
	WarehouseService_CreateWarehouse_FullMethodName = "/foodfolio.v1.WarehouseService/CreateWarehouse"
	WarehouseService_GetWarehouse_FullMethodName    = "/foodfolio.v1.WarehouseService/GetWarehouse"
	WarehouseService_ListWarehouses_FullMethodName  = "/foodfolio.v1.WarehouseService/ListWarehouses"
	WarehouseService_UpdateWarehouse_FullMethodName = "/foodfolio.v1.WarehouseService/UpdateWarehouse"
	WarehouseService_DeleteWarehouse_FullMethodName = "/foodfolio.v1.WarehouseService/DeleteWarehouse"
)
...
type WarehouseServiceClient interface {
	...
	DeleteWarehouse(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
}
...
func (c *warehouseServiceClient) DeleteWarehouse(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type WarehouseServiceServer interface {
	...
	DeleteWarehouse(context.Context, *IdRequest) (*SuccessResponse, error)
...
func (UnimplementedWarehouseServiceServer) DeleteWarehouse(context.Context, *IdRequest) (*SuccessResponse, error) {
...
var WarehouseService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foodfolio.v1.WarehouseService",
