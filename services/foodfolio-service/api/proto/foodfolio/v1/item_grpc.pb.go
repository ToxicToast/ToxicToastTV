...
const (
	ItemService_CreateItem_FullMethodName  = "/foodfolio.v1.ItemService/CreateItem"
	ItemService_GetItem_FullMethodName     = "/foodfolio.v1.ItemService/GetItem"
	ItemService_ListItems_FullMethodName   = "/foodfolio.v1.ItemService/ListItems"
	ItemService_UpdateItem_FullMethodName  = "/foodfolio.v1.ItemService/UpdateItem"
	ItemService_DeleteItem_FullMethodName  = "/foodfolio.v1.ItemService/DeleteItem"
	ItemService_SearchItems_FullMethodName = "/foodfolio.v1.ItemService/SearchItems"
)
...
type ItemServiceClient interface {
	...
	DeleteItem(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error)
...
func (c *itemServiceClient) DeleteItem(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ItemServiceServer interface {
	...
	DeleteItem(context.Context, *IdRequest) (*SuccessResponse, error)
...
func (UnimplementedItemServiceServer) DeleteItem(context.Context, *IdRequest) (*SuccessResponse, error) {
...
var ItemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "foodfolio.v1.ItemService",
